...
This fork focuses only on TF2, Support for other games may be degraded.
...
## TF2 features & changes in this fork

### General
- Improved combat: bots dynamically adjust when to retreat, chase, or hold ground; kill streaks increase aggression
- Projectile dodging catches rockets from behind and handles simultaneous projectiles from opposite directions
- Aim tracking with natural warmup and profile-based turn rate variation
- Better weapon usage across classes: sticky/grenade launcher cycling, self-damage avoidance, item-specific handling
- Sentry engagement: corner-peek splash from cover, coordinated pushes, flanking, overcommitment prevention
- Enemy building response: non-spy bots can attack teleporters and dispensers, team-shared position awareness
- Spy improvements: cloak/uncloak awareness, Dead Ringer and Cloak and Dagger support, better detection
- Bots can join each other's partner taunts
- AFK hijack: takes control of idle human players after configurable seconds
- Voice command responses for additional commands
- Mess-around overhaul, post-kill taunt safety, and crash stack traces

### Classes
- Engineer: smarter building placement, metal and dispenser improvements, Gunslinger and Rescue Ranger support, build fixes
- Medic: uber coordination, healing rotation, sentry-aware positioning while healing, crossbow bolts
- Demoman: sticky launcher cycling, item-specific behavior, sticky trap improvements
- Other: Thermal Thruster, close-range self-damage avoidance, Heavy rev improvements, jar/milk ally extinguish

### MvM
- RED bot revive markers
- Spy bots sap robots
- Engineer building fixes
