...
*DISCLAIMER: The new code in this branch was primarily llm-generated by DeepSeek V4. Listed features below might not work 100% as intended.*

## Features / Changes in this version

### General

- Hijack: takes control of AFK human players after configurable seconds, press any movement key to break free
