...
{
  public:
	CWaypointRadiusIncrease()
	{
		setCaption("Increase Radius (+)");
	}
...
{
  public:
	CWaypointRadiusDecrease()
	{
		setCaption("Decrease Radius (-)");
	}
...
{
  public:
	CWaypointAreaIncrease()
	{
		setCaption("Increase Area (+)");
	}
...
{
  public:
	CWaypointAreaDecrease()
	{
		setCaption("Decrease Area (-)");
	}
...
class CBotMenuList
{
  public:
	...
	static CBotMenu *getMenu(int id)
	{
