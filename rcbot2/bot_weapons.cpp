...
const char *g_szDODWeapons[]   = { "weapon_amerknife", "weapon_spade",      "weapon_colt",         "weapon_p38",
	                               "weapon_m1carbine", "weapon_c96",        "weapon_garand",       "weapon_k98",
	                               "weapon_thompson",  "weapon_mp40",       "weapon_bar",          "weapon_mp44",
	                               "weapon_spring",    "weapon_k98_scoped", "weapon_30cal",        "weapon_mg42",
	                               "weapon_bazooka",   "weapon_pschreck",   "weapon_riflegren_us", "weapon_riflegren_ger",
	                               "weapon_frag_us",   "weapon_frag_ger",   "weapon_smoke_us",     "weapon_smoke_ger",
	                               "weapon_basebomb" };

const char *g_szHL2DMWeapons[] = { "weapon_pistol", "weapon_crowbar", "weapon_357",       "weapon_smg1",
	                               "weapon_ar2",    "weapon_frag",    "weapon_stunstick", "weapon_crossbow",
	                               "weapon_rpg",    "weapon_slam",    "weapon_shotgun",   "weapon_physcannon" };
...
WeaponsData_t DODWeaps[]       = {
    /*
        ...
        */
    { 1, DOD_WEAPON_AMERKNIFE, g_szDODWeapons[0], WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0, 100, -1,
	        1, 0 },
    ...
    { 3, DOD_WEAPON_SPRING, g_szDODWeapons[12],
	        WEAP_FL_PRIM_ATTACK | WEAP_FL_SCOPE | WEAP_FL_CANTFIRE_NORM | WEAP_FL_ZOOMABLE, 0, 3200, -1, 3, 0 },
    { 3, DOD_WEAPON_K98_SCOPED, g_szDODWeapons[13],
	        WEAP_FL_PRIM_ATTACK | WEAP_FL_SCOPE | WEAP_FL_CANTFIRE_NORM | WEAP_FL_ZOOMABLE, 0, 3200, -1, 4, 0 },
    { 3, DOD_WEAPON_20CAL, g_szDODWeapons[14], WEAP_FL_PRIM_ATTACK | WEAP_FL_DEPLOYABLE | WEAP_FL_HIGH_RECOIL, 0, 2000,
	        -1, 4, 0 },
    { 3, DOD_WEAPON_MG42, g_szDODWeapons[15], WEAP_FL_PRIM_ATTACK | WEAP_FL_DEPLOYABLE | WEAP_FL_HIGH_RECOIL, 0, 2000,
	        -1, 4, 0 },
    { 3, DOD_WEAPON_BAZOOKA, g_szDODWeapons[16],
	        WEAP_FL_PROJECTILE | WEAP_FL_EXPLOSIVE | WEAP_FL_PRIM_ATTACK | WEAP_FL_CANTFIRE_NORM | WEAP_FL_DEPLOYABLE, 500,
	        3200, -1, 5, 1300 },
    { 3, DOD_WEAPON_PSCHRECK, g_szDODWeapons[17],
	        WEAP_FL_PROJECTILE | WEAP_FL_EXPLOSIVE | WEAP_FL_PRIM_ATTACK | WEAP_FL_CANTFIRE_NORM | WEAP_FL_DEPLOYABLE, 500,
	        3200, -1, 5, 1300 },
    { 3, DOD_WEAPON_RIFLEGREN_US, g_szDODWeapons[18], WEAP_FL_EXPLOSIVE_SEC | WEAP_FL_PRIM_ATTACK, 500, 1800, -1, 4,
	        0 },
    { 3, DOD_WEAPON_RIFLEGREN_GER, g_szDODWeapons[19], WEAP_FL_EXPLOSIVE_SEC | WEAP_FL_PRIM_ATTACK, 500, 1800, -1, 4,
	        0 },
    { 3, DOD_WEAPON_FRAG_US, g_szDODWeapons[20],
	        WEAP_FL_PROJECTILE | WEAP_FL_GRENADE | WEAP_FL_EXPLOSIVE | WEAP_FL_NONE, 0, 1200, -1, 1, 0 },
    { 3, DOD_WEAPON_FRAG_GER, g_szDODWeapons[21],
	        WEAP_FL_PROJECTILE | WEAP_FL_GRENADE | WEAP_FL_EXPLOSIVE | WEAP_FL_NONE, 0, 1200, -1, 1, 0 },
...
WeaponsData_t HL2DMWeaps[] = {
	...
	*/
	...
	{ 1, HL2DM_WEAPON_CROWBAR, g_szHL2DMWeapons[1], WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0, 128,
	  -1, 1, 0 },
	...
	{ 2, HL2DM_WEAPON_STUNSTICK, g_szHL2DMWeapons[6], WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0, 128,
	  -1, 1, 0 },
	{ 3, HL2DM_WEAPON_CROSSBOW, g_szHL2DMWeapons[7], WEAP_FL_PRIM_ATTACK | WEAP_FL_SCOPE | WEAP_FL_UNDERWATER, 0, 2000,
	  -1, 2, 0 },
	{ 2, HL2DM_WEAPON_RPG, g_szHL2DMWeapons[8],
	  WEAP_FL_PROJECTILE | WEAP_FL_EXPLOSIVE | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 400, 2000, -1, 3, 1000.0f },
...
WeaponsData_t TF2Weaps[] = {
	...
	{ TF2_SLOT_MELEE, TF2_WEAPON_BAT, "tf_weapon_bat", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0, 180,
	  0, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_BOTTLE, "tf_weapon_bottle", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER,
	  0, 180, 0, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_FIREAXE, "tf_weapon_fireaxe", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER,
	  0, 180, 0, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_CLUB, "tf_weapon_club", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0,
	  180, 0, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_KNIFE, "tf_weapon_knife", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0,
	  220, 0, 2, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_FISTS, "tf_weapon_fists", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0,
	  180, 0, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_SHOVEL, "tf_weapon_shovel", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER,
	  0, 180, 0, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_WRENCH, "tf_weapon_wrench", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER,
	  0, 180, 3, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_BONESAW, "tf_weapon_bonesaw", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER,
	  0, 180, 0, 1, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_SHOTGUN_PRIMARY, "tf_weapon_shotgun_primary",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 800, 1, 2, 0 },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_SHOTGUN_SOLDIER, "tf_weapon_shotgun_soldier",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 500, 2, 2, 0 },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_SHOTGUN_HWG, "tf_weapon_shotgun_hwg",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 800, 2, 2, 0 },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_SHOTGUN_PYRO, "tf_weapon_shotgun_pyro",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 800, 2, 2, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_SCATTERGUN, "tf_weapon_scattergun",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 800, 1, 3, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_SNIPERRIFLE, "tf_weapon_sniperrifle", WEAP_FL_SCOPE | WEAP_FL_PRIM_ATTACK, 1000, 4000,
	  1, 3, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_SNIPERRIFLE_DECAP, "tf_weapon_sniperrifle_decap", WEAP_FL_SCOPE | WEAP_FL_PRIM_ATTACK,
	  1000, 4000, 1, 3, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_MINIGUN, "tf_weapon_minigun", WEAP_FL_PRIM_ATTACK | WEAP_FL_HOLDATTACK, 120, 1800, 1,
	  3, 0 },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_SMG, "tf_weapon_smg", WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER,
	  0, 1000, 2, 2, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_SYRINGEGUN, "tf_weapon_syringegun_medic", WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 180,
	  1000, 1, 2, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_ROCKETLAUNCHER, "tf_weapon_rocketlauncher",
	  WEAP_FL_PRIM_ATTACK | WEAP_FL_EXPLOSIVE | WEAP_FL_UNDERWATER, BLAST_RADIUS, 4096, 1, 3, TF2_ROCKETSPEED },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_GRENADELAUNCHER, "tf_weapon_grenadelauncher",
	  WEAP_FL_PROJECTILE | WEAP_FL_PRIM_ATTACK | WEAP_FL_EXPLOSIVE | WEAP_FL_UNDERWATER, 100, 1200, 1, 2,
	  TF2_GRENADESPEED },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_PIPEBOMBS, "tf_weapon_pipebomblauncher",
	  WEAP_FL_PRIM_ATTACK | WEAP_FL_HOLDATTACK | WEAP_FL_PROJECTILE, 0, 1000, 2, 1, 1300 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_FLAMETHROWER, "tf_weapon_flamethrower",
	  WEAP_FL_DEFLECTROCKETS | WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_HOLDATTACK | WEAP_FL_SPECIAL, 0, 400, 1, 3,
	  0 },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_PISTOL, "tf_weapon_pistol",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 2000, 2, 1, 0 },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_PISTOL_SCOUT, "tf_weapon_pistol_scout",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 1800, 2, 2, 0 },
	{ TF2_SLOT_SCNDR, TF2_WEAPON_REVOLVER, "tf_weapon_revolver",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 1400, 2, 1, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_POMSON6000, "tf_weapon_drg_pomson", WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 800,
	  1, 2, 0 },
	...
	{ TF2_SLOT_SCNDR, TF2_WEAPON_SHOTGUN, "tf_weapon_shotgun",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 500, 2, 2, 0 },
	...
	{ TF2_SLOT_PRMRY, TF2_WEAPON_FRONTIERJUSTICE, "tf_weapon_sentry_revenge",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 800, 1, 2, 0 },
	...
	{ TF2_SLOT_MELEE, TF2_WEAPON_SAXXY, "saxxy", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0, 150, 0, 1,
	  0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_BAT_WOOD, "tf_weapon_bat_wood",
	...
	{ TF2_SLOT_PRMRY, TF2_WEAPON_DIRECTHIT, "tf_weapon_rocketlauncher_directhit",
	  WEAP_FL_PRIM_ATTACK | WEAP_FL_EXPLOSIVE | WEAP_FL_UNDERWATER, BLAST_RADIUS, 4096, 1, 3, TF2_ROCKETSPEED * 1.8 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_SWORD, "tf_weapon_sword", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER, 0,
	  190, 0, 1, 0 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_KATANA, "tf_weapon_katana", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER,
	  0, 210, 0, 1, 0 },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_COWMANGLER, "tf_weapon_particle_cannon",
	  WEAP_FL_KILLPIPEBOMBS | WEAP_FL_PRIM_ATTACK | WEAP_FL_UNDERWATER, 0, 1500, 1, 2, TF2_ROCKETSPEED },
	{ TF2_SLOT_PRMRY, TF2_WEAPON_CROSSBOW, "tf_weapon_crossbow",
	  WEAP_FL_PRIM_ATTACK | WEAP_FL_PROJECTILE, 600, 2500, 1, 3, 2400 },
	{ TF2_SLOT_MELEE, TF2_WEAPON_CLEAVER, "tf_weapon_cleaver", WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE | WEAP_FL_UNDERWATER,
	  0, 150, 0, 1, 0 },
...
bool CBotWeapons::update(bool bOverrideAllFromEngine)
{
	...
	for (i = 0; i < MAX_WEAPONS; i++)
	{
		...
		iWeaponsSignature += ((unsigned int)pWeapon)
		                   + ((pWeapon == nullptr) ? 0 : (unsigned int)CClassInterface::getWeaponState(pWeapon));
		m_Weapon_iter++;
	}
...
bool CBotWeapons::update ( bool bOverrideAllFromEngine )
{
    ...
    for ( i = 0; i < MAX_WEAPONS; i ++ )
    {
        // create a 'hash' of current weapons
        pWeapon = (m_Weapon_iter==nullptr) ? nullptr : INDEXENT(m_Weapon_iter->GetEntryIndex());
        iWeaponsSignature += ((unsigned int)pWeapon) + ((pWeapon == nullptr) ? 0 : (unsigned
int)CClassInterface::getWeaponState(pWeapon)); m_Weapon_iter++;
    }
    ...
    if ( iWeaponsSignature != m_iWeaponsSignature ) // m_fUpdateWeaponsTime < engine->Time() )
    {
        ...
        for ( i = 0; i < MAX_WEAPONS; i ++ )
        {
            ...
            if ( (m_BotWeapon_iter->getWeaponInfo()!=nullptr) &&
(m_BotWeapon_iter->getWeaponInfo()->getWeaponName()!=nullptr)
)
            {
                for ( j = 0; j < MAX_WEAPONS; j ++ )
                {
...
strcmp(pWeapon->GetClassName(),m_BotWeapon_iter->getWeaponInfo()->getWeaponName())==0 )
                    {
                        iWeaponState = CClassInterface::getWeaponState(pWeapon);
                        // found it
                        bFound = true;
...
CBotWeapon *CBotWeapons::getBestWeapon(edict_t *pEnemy, bool bAllowMelee, bool bAllowMeleeFallback, bool bMeleeOnly,
                                       bool bExplosivesOnly, bool bIgnorePrimaryMinimum)
{
	...
	if (bMeleeOnly
	    || (bAllowMeleeFallback
	        && ((m_theBestWeapon == nullptr) && (flDist < 400.0f)
	            && (fabs(vEnemyOrigin.z - m_pBot->getOrigin().z) < BOT_JUMP_HEIGHT))))
...
const char *szWeaponFlags[] = { "primary_attack",
	                            "secondary_attack",
	                            "explosive",
	                            "melee",
	                            "underwater",
