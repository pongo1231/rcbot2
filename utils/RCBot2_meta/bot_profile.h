...
class CBotProfile
{
  public:
	...
	// setup profile
	CBotProfile(const char *szName, const char *szModel, int iTeam, int iVisionTicks, int iPathTicks,
	            int iVisionTicksClients, int iSensitivity, float fBraveness, float fAimSkill, int iClass = 0);
