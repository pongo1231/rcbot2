...
{
  public:
	CBotFuncResetAttackPoint(int team)
	{
		iTeam = team;
	}
...
{
  public:
	CBotFuncResetDefendPoint(int team)
	{
		iTeam = team;
	}
	void execute(CBot *pBot)
...
CTeamControlPointRound *CTeamControlPointMaster::getCurrentRound()
{
	...
	// HACK: we use one of the known CBaseEntity-sized entities to compute the offset to the first subclass member for
	// CTeamControlPointMaster / CTeamControlPointRound
...
void CTFObjectiveResource::setup()
{
	...
	for (int j = 0; j < *m_iNumControlPoints; j++)
	{
		...
		{
			iWpt = CWaypointLocations::NearestWaypoint(vOrigin, 1024.0f, -1, false, false, false, NULL, false, 0, false,
...
void CTFObjectiveResource::debugprint(void)
{
	...
	CBotGlobals::botMessage(pEdict, 0, "m_bBlocked[8]\t[%s,%s,%s,%s,%s,%s,%s,%s]", m_bBlocked[0] ? "Y" : "N",
	                        m_bBlocked[1] ? "Y" : "N", m_bBlocked[2] ? "Y" : "N", m_bBlocked[3] ? "Y" : "N",
	                        m_bBlocked[4] ? "Y" : "N", m_bBlocked[5] ? "Y" : "N", m_bBlocked[6] ? "Y" : "N",
	                        m_bBlocked[7] ? "Y" : "N");
	CBotGlobals::botMessage(pEdict, 0, "m_bCPLocked[byte]\t[%d]", *m_bCPLocked);
	CBotGlobals::botMessage(pEdict, 0, "m_bCPLocked[8]\t[%s,%s,%s,%s,%s,%s,%s,%s]", m_bCPLocked[0] ? "Y" : "N",
	                        m_bCPLocked[1] ? "Y" : "N", m_bCPLocked[2] ? "Y" : "N", m_bCPLocked[3] ? "Y" : "N",
	                        m_bCPLocked[4] ? "Y" : "N", m_bCPLocked[5] ? "Y" : "N", m_bCPLocked[6] ? "Y" : "N",
	                        m_bCPLocked[7] ? "Y" : "N");
	CBotGlobals::botMessage(pEdict, 0, "m_bCPIsVisible[8]\t[%s,%s,%s,%s,%s,%s,%s,%s]", m_bCPIsVisible[0] ? "Y" : "N",
	                        m_bCPIsVisible[1] ? "Y" : "N", m_bCPIsVisible[2] ? "Y" : "N", m_bCPIsVisible[3] ? "Y" : "N",
	                        m_bCPIsVisible[4] ? "Y" : "N", m_bCPIsVisible[5] ? "Y" : "N", m_bCPIsVisible[6] ? "Y" : "N",
	                        m_bCPIsVisible[7] ? "Y" : "N");
	CBotGlobals::botMessage(pEdict, 0, "m_iOwner[8]\t[%s,%s,%s,%s,%s,%s,%s,%s]",
	                        (m_iOwner[0] == 2) ? "red" : ((m_iOwner[0] == 3) ? "blue" : "unassigned"),
	                        (m_iOwner[1] == 2) ? "red" : ((m_iOwner[1] == 3) ? "blue" : "unassigned"),
	                        (m_iOwner[2] == 2) ? "red" : ((m_iOwner[2] == 3) ? "blue" : "unassigned"),
	                        (m_iOwner[3] == 2) ? "red" : ((m_iOwner[3] == 3) ? "blue" : "unassigned"),
	                        (m_iOwner[4] == 2) ? "red" : ((m_iOwner[4] == 3) ? "blue" : "unassigned"),
	                        (m_iOwner[5] == 2) ? "red" : ((m_iOwner[5] == 3) ? "blue" : "unassigned"),
	                        (m_iOwner[6] == 2) ? "red" : ((m_iOwner[6] == 3) ? "blue" : "unassigned"),
	                        (m_iOwner[7] == 2) ? "red" : ((m_iOwner[7] == 3) ? "blue" : "unassigned"));
}
...
{
    return (CTeamControlPoint*)((((unsigned long)pent) + rcbot_const_point_offset.GetInt()));
