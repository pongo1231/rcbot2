...
// nearest waypoint finding and waypoint displaying.
{
  public:
	...
	*/
	...
	static void getMinMaxs(int iLoc, int jLoc, int kLoc, int *iMinLoc, int *jMinLoc, int *kMinLoc, int *iMaxLoc,
	                       int *jMaxLoc, int *kMaxLoc);

	static int GetCoverWaypoint(Vector vPlayerOrigin, Vector vCoverFrom, WaypointList *iIgnoreWpts,
	                            Vector *vGoalOrigin = NULL, int iTeam = 0, float fMinDist = MIN_COVER_MOVE_DIST,
	...
	static void FindNearestCoverWaypointInBucket(int i, int j, int k, const Vector &vOrigin, float *pfMinDist,
	                                             ...
	                                             Vector *vGoalOrigin = NULL, int iTeam = 0,
	...
	static void FindNearestInBucket(int i, int j, int k, const Vector &vOrigin, float *pfMinDist, int *piIndex,
	                                ...
	                                bool bIsBot = false, WaypointList *iFailedWpts = NULL,
	                                ...
	                                int iFlagsOnly = 0, edict_t *pPlayer = NULL);
	...
	static int NearestGrenadeWaypoint(const Vector &vTarget, int iTeam, bool bCheckArea,
	                                  float fBlastRadius = BLAST_RADIUS);
